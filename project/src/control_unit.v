...
module unit (
 ...
 always @* begin
   ...
   control_unit_out[5:2] = 4'b0;
   /* verilator lint_off WIDTH */ case (type_decode_in[3:0])
      4'b0001 : control_unit_out[10:9] = 2'b01;
      4'b0010 : control_unit_out[10:9] = 2'b11;
      4'b0100 : control_unit_out[10:9] = 2'b10;
      4'b1000 : control_unit_out[10:9] = 2'b10;
